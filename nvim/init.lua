...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ws', builtin.live_grep, { desc = '[W]ord [S]earch' })
      ...
      vim.keymap.set('n', '<leader>+', builtin.spell_suggest, { desc = '[+] Spell suggest' })
      vim.keymap.set('n', '<leader>}', builtin.colorscheme, { desc = '[}] Search colorscheme' })
      ...
      end, { desc = 'neo[V]im files [S]earch' })
    end,
  },
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('vfr', require('telescope.builtin').lsp_references, '[G]oto [R]eferences')

          -- Jump to the implementation of the word under your cursor.
          --  Useful when your language has ways of declaring types without an actual implementation.
          map('vfi', require('telescope.builtin').lsp_implementations, '[G]oto [I]mplementation')
